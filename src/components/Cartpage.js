    ...
    const handleCheckout = () => {
        ...
        processTimeoutRef.current = setTimeout(() => {
            ...
            redirectTimeoutRef.current = setTimeout(() => {
                //  The state object is a special property in React Router that allows you to pass additional data along with the navigation
                navigate("/checkout", { state: { orderTotal, orderItems: cart } });
            }, 1000);
        }, 2000);
    };
    ...
    return (
        <div className="bg-gray-100 min-h-screen py-8">
            <div className="container mx-auto px-4">
                <h1 className="text-2xl flex justify-center items-center md:text-3xl font-bold mb-4">
                    Your Shopping Cart
                </h1>
                {checkoutMessage && (
                    <div
                        ...
                        <div className="md:w-3/4">
                            <div className="bg-white rounded-lg shadow-md p-6 mb-4">
                                ...
                                {cart.map((item) => (
                                    <div
                                        key={item.id}
                                        className="mb-6 md:mb-4 md:grid md:grid-cols-6 md:gap-4 md:items-center border-b pb-4"
                                    >
                                        ...
                                        <div className="flex items-center mb-2 md:mb-0">
                                            ...
                                            <div className="flex items-center border rounded-md">
                                                <button
                                                    className={`px-3 py-1 border-r ${item.quantity <= 1
                        ...
                        <div className="md:w-1/4">
                            <div className="bg-white rounded-lg shadow-md p-6">
                                ...
                                <button
                                    ...
                                    disabled={checkoutMessage !== ""}
                                >
                                    {checkoutMessage ? "Processing..." : "Proceed to Checkout"}
                                </button>
                            </div>
                        </div>
                    </div>
